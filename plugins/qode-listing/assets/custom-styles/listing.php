...
if(!function_exists('qode_listing_first_color_styles')){
	function qode_listing_first_color_styles(){
		...
		if(!empty($first_color)) {
			...
			echo qode_dynamic_css($border_color_selector, $border_color_styles);
			echo qode_dynamic_css($border_top_color_selector, $border_top_color_styles);
			echo qode_dynamic_css($path_selector, $path_selector);
		}
	}

	add_action('qode_style_dynamic', 'qode_listing_first_color_styles');
}